    ...
    public class DependencyInjector
    {
        ...
        public static void Inject()
        {
            ...
            Services = new ServiceCollection()
                ...
                {
                    DisconnectDelay = TimeSpan.FromMinutes(Convert.ToDouble(ConfigurationHandler.Data.DisconnectInVoiceChannelAfterInMinutes)),
                    PollInterval = TimeSpan.FromSeconds(30.00),
                    TrackInactivity = true,
                })

                .AddSingleton<CommandPrefixService>()
