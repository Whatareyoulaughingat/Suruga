...
using Suruga.DSharpPlus.Injectors;

namespace Suruga.DSharpPlus.Services;
...
public class ChannelService
{
    ...
    public async Task<DiscordMessage> DeleteTextChannelAsync(DiscordChannel commandExecutedChannel, DiscordMember member, DiscordChannel toBeDeletedChannel)
    {
